...
Ciekawe książki i strony internetowe zamieszczone zostały w zakładce [książki](/RTA_2025/ksiazki). 
...
3. 04-03-2025 (wtorek) 13:30-15:10 - Wykład 3
...
W trakcie laboratoriów realizowane będą zadania domowe przekazywane za pośrednictwem platformy teams.  
Każdy brak zadania domowego obniża końcową ocenę o 0.5 stopnia.

Projekt powinien być realizowany w grupach max. 5 osobowych. 

Wymagania projektu: 

- Projekt powinien przedstawiać REALNY PROBLEM BIZNESOWY, który można realizować wykorzystując informacje podawane w trybie online. (Nie oznacza to, że nie można korzystać z procesowania batchowego np w celu wygenerowania modelu).
- Dane powinny być przesyłane do systemu Apache Kafka i stamtąd poddawane dalszemu procesowaniu i analizie. 
- Język programowania jest dowolny - dotyczy każdego komponentu projektu. 
- Można wykorzystać narzędzia BI 
- Źródłem danych może być dowolne API lub sztucznie generowane dane, IoT itp.
